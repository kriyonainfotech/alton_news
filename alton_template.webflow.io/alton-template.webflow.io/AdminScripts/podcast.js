document.getElementById("newsForm").addEventListener("submit", async function (event) {
    ...
    formData.append("podcast", newsImage);
    ...
    try {
        const response = await fetch("http://localhost:3000/podcast/addNews", {
            method: "POST",
            body: formData,
        });
...
const fetchNews = async () => {
    ...
    let tbl = "";
    try {
        const response = await fetch("http://localhost:3000/podcast/getAllNews");
...
const deleteNewsItem = async (newsId) => {
    alert(newsId)
    try {
        const response = await fetch("http://localhost:3000/podcast/deleteNews", {
            method: "DELETE",
            headers: {
...
async function submitUpdate() {
    ...
    try {
        const response = await fetch("http://localhost:3000/podcast/updateNews", {
            method: "PUT",
            body: formData,
        });
